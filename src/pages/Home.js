        ...
        <div className="right">
          ...
          <div className="right-sidebar" style={{ height: "40vh" }}>
            ...
            <p className="px-4" style={{ textAlign: "justify" }}>
              The "Add and Drop" feature in an LMS allows students to manage
              their course enrollments efficiently. Within a specified period,
              students can add new courses to their schedule or drop existing
              ones. This flexibility helps students tailor their academic
              workload, ensuring they can balance their studies with other
              commitments. It also allows them to adjust their learning paths
